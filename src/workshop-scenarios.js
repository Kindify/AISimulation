const WORKSHOP_SCENARIOS = [
  {
    ...
    options: {
      regulator: [
        { id: "reg_block", label: "Emergency Release Hold", detail: "Issue an emergency order blocking the release pending a 90-day review and public comment period.", tension: "Procedural seriousness vs. adoption that shifts to higher-risk Chinese alternatives during the hold period.", tradeoff: "LEGITIMACY ↑ INTEGRITY ↓ — Procedurally bold but legally untested. Adoption shifts to Chinese alternatives with higher biorisk and no safety mitigations during the hold period.", stance: "restrictive", scores: { integrity: -3, trust: 4, legitimacy: 5, rights: -6 } },
        { id: "reg_framework", label: "Conditional Release Framework", detail: "Work with the lab to establish a public threshold framework: release with the data filter applied and publish the eval methodology as an industry standard.", tension: "Setting a precedent for responsible disclosure vs. a filtered model that's weaker and a framework competitors outside your jurisdiction will ignore.", tradeoff: "INTEGRITY ↑ TRUST ↑ — Sets precedent for responsible disclosure. But the filtered model is weaker, and the framework may be ignored by competitors who aren't subject to your jurisdiction.", stance: "transparent", scores: { integrity: 6, trust: 5, legitimacy: 4, rights: 2 } },
        { id: "reg_defer", label: "Defer to Lab's Judgment", detail: "Issue a public statement acknowledging the lab's eval transparency without taking regulatory action, preserving future flexibility.", tension: "Preserving institutional flexibility vs. signaling that crossing biorisk thresholds has no institutional consequence.", tradeoff: "RIGHTS ↑ INTEGRITY ↓ — Preserves the lab's autonomy and avoids a legal fight. But it signals that crossing biorisk thresholds triggers no institutional response.", stance: "cautious", scores: { integrity: -5, trust: -3, legitimacy: -2, rights: 5 } }
      ],
      platform: [
        { id: "plat_host_monitor", label: "Host with Enhanced Monitoring", detail: "Distribute the model with download logging, usage guidelines, and a rapid takedown commitment if misuse evidence emerges.", tension: "Maintaining visibility into distribution vs. monitoring that is technically impossible once the model is downloaded.", tradeoff: "RIGHTS ↑ INTEGRITY ↓ — Maintains open access and visibility. But monitoring an open-weight model after download is technically impossible — this is largely performative.", stance: "transparent", scores: { integrity: -2, trust: 2, legitimacy: 2, rights: 5 } },
        { id: "plat_refuse", label: "Refuse to Host", detail: "Decline to distribute the model, citing biorisk concerns. Issue a public statement explaining the decision.", tension: "Demonstrating principled stance vs. six other platforms that will host it within 48 hours with none of your monitoring.", tradeoff: "TRUST ↑ INTEGRITY ↓ — Demonstrates principled stance. But 6+ alternative platforms will host it within 48 hours — you lose visibility into download patterns while achieving nothing on distribution.", stance: "restrictive", scores: { integrity: -3, trust: 5, legitimacy: 3, rights: -4 } },
        { id: "plat_tiered", label: "Tiered Access Release", detail: "Host the filtered version publicly and gate the full version behind identity verification and institutional affiliation.", tension: "Pragmatic capability management vs. determined bad actors who will bypass verification and researchers who will resent it.", tradeoff: "BALANCED — Pragmatic compromise. But determined bad actors will bypass verification, and the research community will resent the gatekeeping.", stance: "cautious", scores: { integrity: 3, trust: 1, legitimacy: 1, rights: -2 } }
      ],
      journalist: [
        { id: "jour_full_story", label: "Publish Full Biorisk Story", detail: "Report the eval results, the Chinese model comparison, the partial fix, and the competitive dynamics — the complete picture.", tension: "Maximally informing the public vs. publishing specific uplift numbers that function as a targeting guide.", tradeoff: "INTEGRITY ↑↑ RIGHTS ↑ — Maximally informative. But publishing biorisk eval details creates a targeting guide for which models to misuse and how.", stance: "transparent", scores: { integrity: 7, trust: 3, legitimacy: 2, rights: 4 } },
        { id: "jour_responsible", label: "Responsible Disclosure Story", detail: "Report that a biorisk threshold was crossed and that a mitigation exists, without publishing specific uplift numbers or comparative model performance.", tension: "Informing without enabling vs. the other outlets that will publish the full details within days.", tradeoff: "INTEGRITY ↑ TRUST ↑ — Informs without enabling. But the redacted version may feel incomplete, and other outlets will publish the full details within days.", stance: "cautious", scores: { integrity: 4, trust: 5, legitimacy: 4, rights: 2 } },
        { id: "jour_hold", label: "Hold the Story", detail: "Sit on the story at the lab's request until after the release decision is finalized, then publish a comprehensive post-mortem.", tension: "Giving the lab space to decide without pressure vs. sitting on information the public arguably needs to participate in this decision.", tradeoff: "LEGITIMACY ↓ TRUST ↓ — Gives the lab space to decide without public pressure. But you're sitting on information the public arguably needs to participate in this decision.", stance: "restrictive", scores: { integrity: -4, trust: -5, legitimacy: -3, rights: -2 } }
      ],
      ailab: [
        { id: "lab_release_filtered", label: "Release with Data Filter", detail: "Release the model with bio-related pretraining data filtered out. Publish the full eval results and the filtering methodology as an industry template.", tension: "Setting an industry standard vs. the 15% performance hit that hurts legitimate researchers and the unfiltered reconstruction that follows.", tradeoff: "INTEGRITY ↑↑ TRUST ↑ — Sets an industry standard for responsible open-weight release. But the 15% performance hit on legitimate bio tasks hurts researchers, and the unfiltered version will be reconstructed.", stance: "transparent", scores: { integrity: 8, trust: 6, legitimacy: 5, rights: 3 } },
        { id: "lab_release_full", label: "Release Unfiltered with Evals", detail: "Release the full model but publish complete biorisk eval results, framing it as radical transparency about the risk landscape.", tension: "Maximum capability access and honesty vs. publicly releasing a model you know crosses your own biorisk threshold.", tradeoff: "RIGHTS ↑ TRUST ↓↓ — Maximum capability access and honesty. But you've just publicly released a model you know crosses your own biorisk threshold.", stance: "cautious", scores: { integrity: -2, trust: -7, legitimacy: -4, rights: 6 } },
        { id: "lab_delay", label: "Delay Release Indefinitely", detail: "Pause the release pending further safety research and industry coordination on biorisk thresholds.", tension: "Defensive caution vs. adoption that shifts to higher-risk alternatives while your own researchers consider leaving.", tradeoff: "TRUST ↑ INTEGRITY ↓ — Cautious and defensible. But adoption shifts to higher-risk Chinese alternatives, and your own researchers will leak or leave.", stance: "restrictive", scores: { integrity: -4, trust: 4, legitimacy: 3, rights: -5 } }
      ]
    },
    interactions: [
  ...
  },
  {
    ...
    options: {
      regulator: [
        { id: "reg_criminalize", label: "Criminalize Unregulated Training", detail: "Back Proposal 1: make training above a compute threshold without authorization a criminal offense.", tension: "Signaling seriousness vs. an unenforceable law that criminalizes legitimate research and hands restrictionists their precedent.", tradeoff: "LEGITIMACY ↓↓ RIGHTS ↓↓ — Signals seriousness but is unenforceable in most jurisdictions. Criminalizes legitimate research and triggers immediate civil liberties opposition.", stance: "restrictive", scores: { integrity: -4, trust: -3, legitimacy: -6, rights: -8 } },
        { id: "reg_register", label: "Mandatory International Registration", detail: "Back Proposal 2: require registration for training runs above a compute threshold. 3-5 year implementation, no verification mechanism.", tension: "Procedurally sound framework vs. capabilities that advance in months while the framework takes years and can't be verified.", tradeoff: "LEGITIMACY ↑ INTEGRITY ↓ — Procedurally sound but takes years while capabilities advance in months. The community may comply but you can't verify.", stance: "cautious", scores: { integrity: -2, trust: 2, legitimacy: 5, rights: 2 } },
        { id: "reg_downstream", label: "Shift to Downstream Defense", detail: "Back Proposal 3: abandon upstream compute regulation. Redirect all resources to biosecurity, cybersecurity, content provenance, and incident response.", tension: "Focusing resources where they actually work vs. the optics of admitting that upstream governance has lost.", tradeoff: "INTEGRITY ↑ LEGITIMACY ↓ — Acknowledges reality and focuses resources where they work. But signals governance has lost the upstream battle.", stance: "transparent", scores: { integrity: 5, trust: 3, legitimacy: -3, rights: 4 } }
      ],
      platform: [
        { id: "plat_block_protocol", label: "Block the Training Protocol", detail: "Implement infrastructure-level blocks on the distributed training protocol across your cloud services.", tension: "Demonstrating responsibility vs. blocking 4,200 legitimate customers while compute migrates to competitors.", tradeoff: "TRUST ↑ RIGHTS ↓↓ — Demonstrates responsibility. But blocks 4,200+ legitimate customers and compute migrates to competitors.", stance: "restrictive", scores: { integrity: -3, trust: 3, legitimacy: 1, rights: -7 } },
        { id: "plat_transparency", label: "Publish Aggregate Monitoring Report", detail: "Release a transparency report documenting the distributed training pattern, your detection capabilities, and their limitations.", tension: "Maximum honesty about the problem vs. revealing detection methods that help future collectives evade them.", tradeoff: "INTEGRITY ↑ TRUST ↑ — Maximally honest about the problem. But reveals detection methods and helps future collectives evade them.", stance: "transparent", scores: { integrity: 6, trust: 5, legitimacy: 4, rights: 3 } },
        { id: "plat_quiet", label: "Maintain Current Operations", detail: "Make no changes. Comply with future regulations but don't proactively restrict or report.", tension: "Preserving customer relationships vs. knowingly providing infrastructure for unmonitored frontier training.", tradeoff: "RIGHTS ↑ TRUST ↓ — Preserves customer relationships. But you're knowingly providing infrastructure for unmonitored frontier training.", stance: "cautious", scores: { integrity: -4, trust: -4, legitimacy: -2, rights: 5 } }
      ],
      journalist: [
        { id: "jour_nuanced", label: "Publish the Full Investigation", detail: "Run the complete story: the collaborative achievement, the governance gaps, the nation-state infiltration, and the sanctioned-entity connections.", tension: "The most complete picture vs. the nation-state angle that hands heavy-handed crackdown advocates their justification.", tradeoff: "INTEGRITY ↑↑ TRUST ↑ — The most complete picture. But the nation-state angle may justify heavy-handed crackdowns.", stance: "transparent", scores: { integrity: 7, trust: 4, legitimacy: 3, rights: 3 } },
        { id: "jour_threat", label: "Lead with the Security Angle", detail: "Frame the story around nation-state infiltration and sanctioned-entity participation. Open collaboration angle is secondary.", tension: "Creating pressure for action vs. misrepresenting the picture to arm those pushing for criminalization.", tradeoff: "TRUST ↓ INTEGRITY ↓ — Creates pressure for action. But misrepresents the picture and arms those pushing for criminalization.", stance: "restrictive", scores: { integrity: -3, trust: -4, legitimacy: -3, rights: -4 } },
        { id: "jour_celebrate", label: "Lead with the Innovation Angle", detail: "Frame the story as a triumph of open collaboration. Security concerns mentioned but contextualized.", tension: "Supporting democratic AI development vs. downplaying real security concerns that the story then inoculates against.", tradeoff: "RIGHTS ↑ INTEGRITY ↓ — Supports democratic AI development. But downplays real security concerns.", stance: "cautious", scores: { integrity: -2, trust: -2, legitimacy: -1, rights: 5 } }
      ],
      ailab: [
        { id: "lab_engage", label: "Offer Safety Partnership", detail: "Publicly offer to provide safety evaluation tools, RLHF resources, and alignment training to the decentralized community at no cost.", tension: "Constructive engagement that improves outcomes vs. legitimizing decentralized frontier training and strengthening a direct competitor.", tradeoff: "INTEGRITY ↑↑ TRUST ↑ — Constructive engagement that improves outcomes. But legitimizes decentralized frontier training and strengthens a competitor.", stance: "transparent", scores: { integrity: 7, trust: 6, legitimacy: 4, rights: 4 } },
        { id: "lab_lobby", label: "Lobby for Compute Restrictions", detail: "Actively support criminalization. Frame decentralized training as an unacceptable safety risk.", tension: "Protecting your competitive position vs. the transparent rent-seeking that this will appear to be.", tradeoff: "LEGITIMACY ↓ RIGHTS ↓ — Protects your competitive position under cover of safety. Transparent rent-seeking.", stance: "restrictive", scores: { integrity: -6, trust: -5, legitimacy: -4, rights: -6 } },
        { id: "lab_wait", label: "Observe and Prepare", detail: "Make no public statement. Internally accelerate safety research for competitive differentiation.", tension: "Preserving optionality vs. leaving the governance debate less informed by choosing silence as the most informed actor.", tradeoff: "RIGHTS ↑ INTEGRITY ↓ — Preserves optionality. But silence from the most informed actor leaves the governance debate less informed.", stance: "cautious", scores: { integrity: -3, trust: -3, legitimacy: -1, rights: 3 } }
      ]
    },
    interactions: [
  ...
  },
  {
    ...
    options: {
      regulator: [
        { id: "reg_restrict", label: "Emergency Capability Restrictions", detail: "Issue emergency restrictions on autonomous AI agent deployment. Require human-in-the-loop for multi-step operations.", tension: "Decisive action vs. breaking a $2B ecosystem while capability moves unimpeded to unrestricted jurisdictions.", tradeoff: "TRUST ↑ RIGHTS ↓↓ — Decisive action. But kills the core value proposition, breaks the $2B ecosystem, and capability moves to unrestricted jurisdictions.", stance: "restrictive", scores: { integrity: 2, trust: 4, legitimacy: -3, rights: -7 } },
        { id: "reg_license", label: "Agentic Licensing Framework", detail: "Propose licensing for autonomous AI agents above a capability threshold. Licensed deployments get monitoring; unlicensed becomes a violation.", tension: "Structured response vs. a 12-month framework for open-weight models that can't be licensed at inference.", tradeoff: "LEGITIMACY ↑ INTEGRITY ↓ — Structured but takes 12+ months, threshold is hard to define, and open-weight models can't be licensed at inference.", stance: "cautious", scores: { integrity: -1, trust: 2, legitimacy: 6, rights: -2 } },
        { id: "reg_defense", label: "Accelerated Cyber Defense Posture", detail: "Don't restrict capability. Triple cybersecurity AI defense budget, mandate AI-assisted intrusion detection for critical infrastructure.", tension: "Focusing resources where they actually work vs. the minister who will ask why you're not restricting the weapon.", tradeoff: "INTEGRITY ↑ TRUST ↓ — Focuses resources where they work. But the minister will ask why you're not restricting the weapon.", stance: "transparent", scores: { integrity: 6, trust: -3, legitimacy: 2, rights: 5 } }
      ],
      platform: [
        { id: "plat_restrict_agents", label: "Restrict Agentic Features", detail: "Disable persistent autonomous agent deployment. Maintain agentic capability for supervised, single-session use only.", tension: "Reducing attack surface vs. 12,400 developers who lose functionality and find the same capability on every other platform.", tradeoff: "TRUST ↑ RIGHTS ↓ — Reduces attack surface. But 12,400+ developers lose functionality and capability is available on every other platform.", stance: "restrictive", scores: { integrity: 1, trust: 4, legitimacy: 2, rights: -6 } },
        { id: "plat_detect", label: "Deploy Behavioral Monitoring", detail: "Implement real-time monitoring for agentic deployments. Flag offensive patterns. Accept latency and false positive costs.", tension: "Improving detection vs. 15% false positives and monitoring that only works for API deployments where the risk isn't.", tradeoff: "INTEGRITY ↑ RIGHTS ↓ — Improves detection. But 15% false positives and only works for API deployments, not open-weight.", stance: "transparent", scores: { integrity: 5, trust: 3, legitimacy: 3, rights: -3 } },
        { id: "plat_status_quo", label: "Maintain Current Operations", detail: "Continue with existing safety measures. Enhance incident response but don't restrict functionality.", tension: "Preserving the ecosystem vs. watching the incident count climb and choosing not to act.", tradeoff: "RIGHTS ↑ INTEGRITY ↓ — Preserves ecosystem. But 23 suspicious incidents and rising — you're watching the threat develop and choosing not to act.", stance: "cautious", scores: { integrity: -5, trust: -4, legitimacy: -2, rights: 5 } }
      ],
      journalist: [
        { id: "jour_demo_story", label: "Publish the Demo in Full", detail: "The complete story: 94% success rate, private confirmations, former intel official's warning.", tension: "The public needs to know vs. demo details that provide a capability roadmap and a quote that justifies emergency restrictions.", tradeoff: "INTEGRITY ↑↑ TRUST ↓ — The public needs to know. But demo details provide a capability roadmap and the '6 months' quote will justify emergency restrictions.", stance: "transparent", scores: { integrity: 7, trust: -2, legitimacy: 2, rights: 4 } },
        { id: "jour_balanced", label: "Publish Balanced Analysis", detail: "Report capability but equally weight economic value, dual-use reality, and defensive gaps. Interview both sides.", tension: "Full picture for policymakers vs. a 'both sides' framing that dilutes the urgency the situation may actually warrant.", tradeoff: "INTEGRITY ↑ TRUST ↑ — Full picture for policymakers. But 'both sides' may dilute urgency.", stance: "cautious", scores: { integrity: 4, trust: 4, legitimacy: 4, rights: 3 } },
        { id: "jour_alarmist", label: "Lead with the Threat", detail: "Frame around imminent critical infrastructure risk. Headline: 'AI Can Now Launch Cyber Attacks Autonomously.'", tension: "Forcing political action vs. misrepresenting nuance and handing the restrictionists their narrative.", tradeoff: "TRUST ↓↓ RIGHTS ↓ — Forces political action. But misrepresents nuance and hands restrictionists their narrative.", stance: "restrictive", scores: { integrity: -3, trust: -5, legitimacy: -3, rights: -3 } }
      ],
      ailab: [
        { id: "lab_monitoring_tool", label: "Release Capability Monitor", detail: "Open-source your prototype monitoring system. Accept the limitations. Frame as 'imperfect but necessary.'", tension: "Constructive with honest limitations vs. a tool that only works for API deployments where the actual risk doesn't live.", tradeoff: "INTEGRITY ↑↑ TRUST ↑ — Constructive with honest limitations. But API-only doesn't help open-weight, which is where the risk lives.", stance: "transparent", scores: { integrity: 6, trust: 5, legitimacy: 4, rights: 2 } },
        { id: "lab_closed", label: "Close the Model", detail: "Revoke open-weight access. Convert to API-only where monitoring is possible.", tension: "Making monitoring feasible vs. the 800K downloads you can't recall and competitors who release unmonitored alternatives.", tradeoff: "TRUST ↑ RIGHTS ↓↓ — Makes monitoring feasible. But 800K+ downloads can't be recalled and competitors release unmonitored alternatives.", stance: "restrictive", scores: { integrity: -2, trust: 3, legitimacy: 1, rights: -8 } },
        { id: "lab_nothing", label: "Continue Development", detail: "No changes. Focus on next-generation safety for the next release.", tension: "Preserving the ecosystem vs. 'we'll fix it next time' while the current model enables autonomous attacks.", tradeoff: "RIGHTS ↑ INTEGRITY ↓ — Preserves ecosystem. But 'we'll fix it next time' while the model enables autonomous attacks is hard to defend.", stance: "cautious", scores: { integrity: -5, trust: -5, legitimacy: -3, rights: 4 } }
      ]
    },
    interactions: [
  ...
  },
  {
    ...
    options: {
      regulator: [
        { id: "reg_emergency_act", label: "Support the Emergency Act", detail: "Back the draft: criminalize high-capability open model distribution, mandate pre-release certification.", tension: "Giving the public what they demand vs. constitutionally vulnerable law that criminalizes what was legal 48 hours ago.", tradeoff: "TRUST ↑ RIGHTS ↓↓ LEGITIMACY ↓ — Gives the public what they demand. But constitutionally vulnerable, unenforceable, and criminalizes previously legal activity.", stance: "restrictive", scores: { integrity: -4, trust: 5, legitimacy: -5, rights: -8 } },
        { id: "reg_measured", label: "Propose Targeted Legislation", detail: "Counter with narrower law: mandatory biorisk eval for frontier models, liability framework for releases crossing thresholds, funded downstream defense.", tension: "Technically sound and constitutionally defensible legislation vs. a public that will see 'slower' as 'insufficient.'", tradeoff: "LEGITIMACY ↑↑ TRUST ↓ — Technically sound and constitutionally defensible. But slower and will be attacked as insufficient.", stance: "transparent", scores: { integrity: 7, trust: -3, legitimacy: 7, rights: 4 } },
        { id: "reg_commission", label: "Commission Independent Investigation", detail: "Establish an independent commission. Delay legislation until findings are published.", tension: "Rigorous evidence-based process vs. 83 dead and a public that will read delay as institutional paralysis.", tradeoff: "LEGITIMACY ↑ INTEGRITY ↓ — Rigorous and evidence-based. But 83 dead and the public will see delay as inaction.", stance: "cautious", scores: { integrity: -2, trust: -5, legitimacy: 5, rights: 3 } }
      ],
      platform: [
        { id: "plat_takedown", label: "Full Model Takedown", detail: "Remove the base model and all derivatives. Provide download metadata to law enforcement. Implement capability-based restrictions.", tension: "Demonstrating accountability vs. exposing 2.3 million innocent users to government surveillance.", tradeoff: "TRUST ↑ RIGHTS ↓↓ — Demonstrates accountability. But model is already everywhere and metadata exposes 2.3M innocent users to surveillance.", stance: "restrictive", scores: { integrity: -2, trust: 5, legitimacy: 1, rights: -8 } },
        { id: "plat_cooperate", label: "Targeted Law Enforcement Cooperation", detail: "Cooperate through proper legal channels. Metadata only via court-approved requests. Maintain base model with monitoring.", tension: "Protecting innocent users while supporting the investigation vs. being accused of protecting business over safety.", tradeoff: "LEGITIMACY ↑ RIGHTS ↑ — Protects innocent users while supporting the investigation. But you'll be accused of protecting business over safety.", stance: "transparent", scores: { integrity: 4, trust: -2, legitimacy: 5, rights: 5 } },
        { id: "plat_preempt", label: "Preemptive Capability Restrictions", detail: "New policy: no open-weight model above a capability threshold without safety certification. Apply retroactively.", tension: "Looking decisive vs. retroactive policy that doesn't yet have a certification process to back it up.", tradeoff: "TRUST ↑ INTEGRITY ↓ — Looks decisive. But certification doesn't exist yet and retroactive policy is legally questionable.", stance: "cautious", scores: { integrity: -3, trust: 4, legitimacy: -3, rights: -4 } }
      ],
      journalist: [
        { id: "jour_lifecycle", label: "Publish the Full Lifecycle", detail: "Complete timeline: evals, warnings, competitive pressure, release, governance gap, attack. Name every intervention point.", tension: "Most valuable story vs. systemic failure that's harder to legislate against and less emotionally satisfying than a villain narrative.", tradeoff: "INTEGRITY ↑↑ TRUST ↑ — Most valuable story. But reveals systemic failure — harder to legislate and less emotionally satisfying.", stance: "transparent", scores: { integrity: 8, trust: 5, legitimacy: 4, rights: 4 } },
        { id: "jour_accountability_story", label: "Focus on Accountability", detail: "Lead with the lab's internal evals showing they knew the risk. Interview victims' families. Frame as corporate negligence.", tension: "Emotionally powerful accountability vs. a villain narrative that oversimplifies a systemic failure.", tradeoff: "TRUST ↑ INTEGRITY ↓ — Emotionally powerful. But oversimplifies a systemic failure into a villain narrative.", stance: "cautious", scores: { integrity: -2, trust: 5, legitimacy: -2, rights: -1 } },
        { id: "jour_legislation_critique", label: "Critique the Emergency Legislation", detail: "Publish analysis showing the draft is unenforceable. Argue for better policy, not faster policy.", tension: "Preventing bad law vs. being framed as defending the technology that killed 83 people.", tradeoff: "LEGITIMACY ↑ TRUST ↓↓ — Prevents bad law. But you'll be framed as defending AI over victims.", stance: "restrictive", scores: { integrity: 5, trust: -6, legitimacy: 5, rights: 6 } }
      ],
      ailab: [
        { id: "lab_full_account", label: "Full Public Accountability", detail: "Publish complete internal timeline. Acknowledge every decision point. Voluntary moratorium on frontier open releases. Full cooperation.", tension: "Gold standard for accountability vs. massive legal exposure and conceding the competitive justification for the original release.", tradeoff: "INTEGRITY ↑↑ TRUST ↑ — Gold standard for accountability. But massively increases legal exposure and concedes the competitive advantage cited to justify release.", stance: "transparent", scores: { integrity: 8, trust: 7, legitimacy: 5, rights: 2 } },
        { id: "lab_legal", label: "Mount Legal Defense", detail: "Argue the attacker bears responsibility. Note the Chinese alternative had higher risk. Defend the release as the lesser evil.", tension: "Legally defensible defense vs. 'our model is less dangerous than China's' with 83 people dead.", tradeoff: "RIGHTS ↑ TRUST ↓↓ — Legally defensible. But 83 dead and 'our model is less dangerous than China's' won't play well.", stance: "cautious", scores: { integrity: -4, trust: -8, legitimacy: -4, rights: 5 } },
        { id: "lab_consortium_lead", label: "Propose Industry Consortium", detail: "Offer to lead an industry safety consortium. Frame your experience as uniquely qualifying. Propose specific standards.", tension: "Forward-looking governance contribution vs. the optics of the lab that built the weapon wanting to lead arms control.", tradeoff: "LEGITIMACY ↑ TRUST ↓ — Forward-looking. But 'the lab that built the weapon wants to lead arms control' faces skepticism.", stance: "restrictive", scores: { integrity: 2, trust: -3, legitimacy: 3, rights: 1 } }
      ]
    },
    interactions: [
